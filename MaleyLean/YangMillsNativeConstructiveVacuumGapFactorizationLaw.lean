...
theorem YangMillsNativeConstructiveVacuumGapFactorizationLawExportStatement
  ...
  (let L :=
   ...
   L.stepwise_gap_ready = L.direct_gap_ready) :=
  YangMillsNativeConstructiveVacuumGapFactorizationLawWitnessStatement
    RC RD RE
    htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
    hww vtm vobs vrsec vcorr vgapf vhgap
    hE hP evac etest efield
