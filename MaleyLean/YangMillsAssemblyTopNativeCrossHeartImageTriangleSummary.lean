...
/--
Top-level export for the theorem/native/native-cross-heart-image-triangle top
summary.
-/
theorem YangMillsAssemblyTopNativeCrossHeartImageTriangleSummaryExportStatement :
  ...
  exact
    YangMillsAssemblyTopNativeCrossHeartImageTriangleSummaryStatement
      S RC RD RE
