...
/--
Structured package for the constructive-to-endpoint bridge law.
-/
structure YMConstructiveEndpointLawPackage
    (RC : YMConstructiveRoute)
    (RE : YMEndpointCore) where
  law : YMConstructiveSupportsEndpointLaw RC RE
  yields_smearing :
...
def YangMillsConstructiveEndpointLawPackageData
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  YMConstructiveEndpointLawPackage RC RE := by
  ...
  refine
    { law := hO.constructive_supports_endpoint
      yields_smearing := by
        intro hbridge
        exact (hO.constructive_supports_endpoint hbridge).1
      yields_exact_endpoint := by
        intro hbridge
        exact (hO.constructive_supports_endpoint hbridge).2 }

theorem YangMillsConstructiveEndpointLawPackageExistsStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  exact ⟨YangMillsConstructiveEndpointLawPackageData
    RC RD RE
    htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
    hww vtm vobs vrsec vcorr vgapf vhgap
    hE hP evac etest efield⟩

theorem YangMillsConstructiveEndpointLawPackageWitnessStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  have hPck := YangMillsConstructiveEndpointLawPackageExistsStatement
    RC RD RE
    htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
    hww vtm vobs vrsec vcorr vgapf vhgap
    hE hP evac etest efield
