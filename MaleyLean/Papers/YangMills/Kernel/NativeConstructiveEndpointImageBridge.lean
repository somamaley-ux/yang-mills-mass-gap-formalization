...
/--
Typed refinement recording the chosen constructive bounded-base witness
together with its endpoint image.
-/
structure YMNativeConstructiveEndpointImageBridge
...
def YangMillsNativeConstructiveEndpointImageBridgeData
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  YMNativeConstructiveEndpointImageBridge RC RD RE := by
  let O :=
...
theorem YangMillsNativeConstructiveEndpointImageBridgeWitnessStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  (etest : (YangMillsEndpointSemanticBundleData RE hE hP).test_function_space)
  (efield : (YangMillsEndpointSemanticBundleData RE hE hP).field_family) :
  Nonempty (YMNativeConstructiveEndpointImageBridge RC RD RE) /\
  ...
  (let B :=
    YangMillsNativeConstructiveEndpointImageBridgeData
      ...
      hww vtm vobs vrsec vcorr vgapf vhgap
      hE hP evac etest efield
   B.law_object.compatibility.constructive_to_endpoint B.chosen_constructive_bounded_base =
     B.endpoint_image) := by
  let B :=
    YangMillsNativeConstructiveEndpointImageBridgeData
      RC RD RE
