...
/--
Alignment layer tying the theorem/native factorization-law triangle-alignment
surface to the packaged native factorization-law triangle object.
-/
structure YMTheoremAssemblyNativeCrossHeartFactorizationLawTrianglePackageAlignment
    (S : YMLoadBearingSpine)
    (RC : YMConstructiveRoute)
    (RD : YMVacuumGapRoute)
    (RE : YMEndpointCore) where
  theorem_native_cross_heart_factorization_law_triangle_alignment :
    YMTheoremAssemblyNativeCrossHeartFactorizationLawTriangleAlignment S RC RD RE
  native_cross_heart_factorization_law_triangle_package :
    YMNativeCrossHeartFactorizationLawTrianglePackage RC RD RE

def YangMillsTheoremAssemblyNativeCrossHeartFactorizationLawTrianglePackageAlignmentData
  (S : YMLoadBearingSpine)
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  YMTheoremAssemblyNativeCrossHeartFactorizationLawTrianglePackageAlignment S RC RD RE := by
  refine
    { theorem_native_cross_heart_factorization_law_triangle_alignment :=
...
theorem YangMillsTheoremAssemblyNativeCrossHeartFactorizationLawTrianglePackageAlignmentExportStatement
  (S : YMLoadBearingSpine)
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
