...
/--
Typed coherence object for the full native image triangle: the constructive
state image agrees with the chosen vacuum-gap witness, and the resulting
endpoint image agrees with the direct constructive endpoint image.
-/
structure YMNativeCrossHeartImageTriangleCoherence
  ...
  gap_witness_agrees :
    image_assembly.constructive_vacuum_gap.state_level_vacuum_gap_ready.down =
      image_assembly.vacuum_gap_endpoint.chosen_vacuum_gap_ready
  composite_matches_gap_endpoint :
    image_assembly.vacuum_gap_endpoint.law_object.compatibility.vacuum_gap_to_endpoint
      image_assembly.constructive_vacuum_gap.state_level_vacuum_gap_ready.down =
        image_assembly.vacuum_gap_endpoint.endpoint_image
  gap_endpoint_matches_constructive_endpoint :
    image_assembly.vacuum_gap_endpoint.endpoint_image =
      image_assembly.constructive_endpoint.endpoint_image

def YangMillsNativeCrossHeartImageTriangleCoherenceData
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  YMNativeCrossHeartImageTriangleCoherence RC RD RE := by
  let A :=
  ...
  refine
    { image_assembly := A
      gap_witness_agrees := rfl
      composite_matches_gap_endpoint := rfl
      gap_endpoint_matches_constructive_endpoint := rfl }

theorem YangMillsNativeCrossHeartImageTriangleCoherenceWitnessStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  exact
    And.intro ⟨C⟩ <|
      And.intro ⟨C.image_assembly⟩ C.gap_endpoint_matches_constructive_endpoint
