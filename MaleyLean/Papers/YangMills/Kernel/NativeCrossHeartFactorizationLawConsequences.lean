...
/--
Typed consequence layer extracting one representative output from each native
factorization law in the shared assembly.
-/
structure YMNativeCrossHeartFactorizationLawConsequences
  ...
  constructive_endpoint_output : RE.endpoint_object.exact_local_net_endpoint

def YangMillsNativeCrossHeartFactorizationLawConsequencesData
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  YMNativeCrossHeartFactorizationLawConsequences RC RD RE := by
  let A :=
  ...
  refine
    { law_assembly := A
      constructive_gap_output := A.constructive_vacuum_gap.direct_gap_ready
      vacuum_gap_endpoint_output := A.vacuum_gap_endpoint.direct_endpoint_image
      constructive_endpoint_output := A.constructive_endpoint.direct_endpoint_image }

theorem YangMillsNativeCrossHeartFactorizationLawConsequencesWitnessStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
  ...
  exact
    And.intro ⟨C⟩ <|
      And.intro ⟨C.law_assembly⟩ <|
        And.intro C.constructive_gap_output <|
          And.intro C.vacuum_gap_endpoint_output C.constructive_endpoint_output
