...
/--
Alignment layer tying the theorem/native image-alignment surface to the stronger
native triangle-coherence object.
-/
structure YMTheoremAssemblyNativeCrossHeartImageTriangleAlignment
    (S : YMLoadBearingSpine)
    (RC : YMConstructiveRoute)
    (RD : YMVacuumGapRoute)
    (RE : YMEndpointCore) where
  theorem_native_cross_heart_image_alignment :
    YMTheoremAssemblyNativeCrossHeartImageAlignment S RC RD RE
  native_cross_heart_image_triangle_coherence :
    YMNativeCrossHeartImageTriangleCoherence RC RD RE

def YangMillsTheoremAssemblyNativeCrossHeartImageTriangleAlignmentData
  (S : YMLoadBearingSpine)
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  YMTheoremAssemblyNativeCrossHeartImageTriangleAlignment S RC RD RE := by
  refine
    { theorem_native_cross_heart_image_alignment :=
        YangMillsTheoremAssemblyNativeCrossHeartImageAlignmentData
          S RC RD RE
      ...
      native_cross_heart_image_triangle_coherence :=
        YangMillsNativeCrossHeartImageTriangleCoherenceData
          RC RD RE
          htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
          hww vtm vobs vrsec vcorr vgapf vhgap
          hE hP evac etest efield }

theorem YangMillsTheoremAssemblyNativeCrossHeartImageTriangleAlignmentExportStatement
  (S : YMLoadBearingSpine)
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  Nonempty (YMNativeCrossHeartImageTriangleCoherence RC RD RE) /\
  ...
  exact
    And.intro ⟨A⟩ <|
      And.intro ⟨A.theorem_native_cross_heart_image_alignment⟩ <|
        And.intro ⟨A.native_cross_heart_image_triangle_coherence⟩ <|
          And.intro ⟨A.native_cross_heart_image_triangle_coherence.image_assembly⟩ <|
            And.intro
              A.theorem_native_cross_heart_image_alignment.theorem_native_cross_heart_law_alignment.theorem_native_inter_heart_alignment.theorem_native_alignment.theorem_witness.partC_witness <|
              And.intro
                A.theorem_native_cross_heart_image_alignment.theorem_native_cross_heart_law_alignment.theorem_native_inter_heart_alignment.theorem_native_alignment.theorem_witness.partD_witness <|
                A.theorem_native_cross_heart_image_alignment.theorem_native_cross_heart_law_alignment.theorem_native_inter_heart_alignment.theorem_native_alignment.theorem_witness.endpoint_part_witness
