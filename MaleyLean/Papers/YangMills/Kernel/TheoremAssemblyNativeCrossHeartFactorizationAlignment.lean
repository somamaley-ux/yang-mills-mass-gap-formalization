...
/--
Alignment layer tying the theorem/native image-triangle surface to the native
cross-heart factorization consequence layer.
-/
structure YMTheoremAssemblyNativeCrossHeartFactorizationAlignment
    (S : YMLoadBearingSpine)
    (RC : YMConstructiveRoute)
    (RD : YMVacuumGapRoute)
    (RE : YMEndpointCore) where
  theorem_native_cross_heart_image_triangle_alignment :
    YMTheoremAssemblyNativeCrossHeartImageTriangleAlignment S RC RD RE
  native_cross_heart_factorization_consequences :
    YMNativeCrossHeartFactorizationConsequences RC RD RE

def YangMillsTheoremAssemblyNativeCrossHeartFactorizationAlignmentData
  (S : YMLoadBearingSpine)
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  YMTheoremAssemblyNativeCrossHeartFactorizationAlignment S RC RD RE := by
  refine
    { theorem_native_cross_heart_image_triangle_alignment :=
        YangMillsTheoremAssemblyNativeCrossHeartImageTriangleAlignmentData
          S RC RD RE
...
theorem YangMillsTheoremAssemblyNativeCrossHeartFactorizationAlignmentExportStatement
  (S : YMLoadBearingSpine)
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  exact
    And.intro ⟨A⟩ <|
      And.intro ⟨A.theorem_native_cross_heart_image_triangle_alignment⟩ <|
        And.intro ⟨A.native_cross_heart_factorization_consequences⟩ <|
          And.intro
            ⟨YangMillsNativeCrossHeartFactorizationAssemblyData
              ...
              hE hP evac etest efield⟩ <|
            And.intro
              A.theorem_native_cross_heart_image_triangle_alignment.theorem_native_cross_heart_image_alignment.theorem_native_cross_heart_law_alignment.theorem_native_inter_heart_alignment.theorem_native_alignment.theorem_witness.partC_witness <|
              And.intro
                A.theorem_native_cross_heart_image_triangle_alignment.theorem_native_cross_heart_image_alignment.theorem_native_cross_heart_law_alignment.theorem_native_inter_heart_alignment.theorem_native_alignment.theorem_witness.partD_witness
                A.theorem_native_cross_heart_image_triangle_alignment.theorem_native_cross_heart_image_alignment.theorem_native_cross_heart_law_alignment.theorem_native_inter_heart_alignment.theorem_native_alignment.theorem_witness.endpoint_part_witness
