...
/--
Typed law object exposing the constructive-to-endpoint factorization equality as
its own named native law package.
-/
structure YMNativeConstructiveEndpointFactorizationLaw
    (RC : YMConstructiveRoute)
    (RD : YMVacuumGapRoute)
    (RE : YMEndpointCore) where
  factorization : YMNativeConstructiveEndpointFactorization RC RD RE
...
def YangMillsNativeConstructiveEndpointFactorizationLawData
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  YMNativeConstructiveEndpointFactorizationLaw RC RD RE := by
  let F :=
...
theorem YangMillsNativeConstructiveEndpointFactorizationLawWitnessStatement
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  (htrunc : RC.finite_truncation_ready)
