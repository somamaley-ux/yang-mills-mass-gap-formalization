...
/--
Alignment layer tying the theorem/native factorization-law triangle-package
surface to the named law pair extracted from that deepest kernel layer.
-/
structure YMTheoremAssemblyNativeCrossHeartFactorizationLawTriangleNamedLawsAlignment
    (S : YMLoadBearingSpine)
    (RC : YMConstructiveRoute)
    (RD : YMVacuumGapRoute)
    (RE : YMEndpointCore) where
  theorem_native_cross_heart_factorization_law_triangle_package_alignment :
    YMTheoremAssemblyNativeCrossHeartFactorizationLawTrianglePackageAlignment S RC RD RE
  native_cross_heart_factorization_law_triangle_named_laws :
    YMNativeCrossHeartFactorizationLawTriangleNamedLaws RC RD RE

def YangMillsTheoremAssemblyNativeCrossHeartFactorizationLawTriangleNamedLawsAlignmentData
  (S : YMLoadBearingSpine)
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  YMTheoremAssemblyNativeCrossHeartFactorizationLawTriangleNamedLawsAlignment S RC RD RE := by
  refine
    { theorem_native_cross_heart_factorization_law_triangle_package_alignment :=
        YangMillsTheoremAssemblyNativeCrossHeartFactorizationLawTrianglePackageAlignmentData
          S RC RD RE
      ...
      native_cross_heart_factorization_law_triangle_named_laws :=
        YangMillsNativeCrossHeartFactorizationLawTriangleNamedLawsData
          RC RD RE
          htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
          hww vtm vobs vrsec vcorr vgapf vhgap
          hE hP evac etest efield }

theorem YangMillsTheoremAssemblyNativeCrossHeartFactorizationLawTriangleNamedLawsAlignmentExportStatement
  (S : YMLoadBearingSpine)
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  let A :=
    YangMillsTheoremAssemblyNativeCrossHeartFactorizationLawTriangleNamedLawsAlignmentData
      S RC RD RE
      htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
      hww vtm vobs vrsec vcorr vgapf vhgap
      hE hP evac etest efield
  ...
  exact
    And.intro ⟨A⟩ <|
      And.intro ⟨A.theorem_native_cross_heart_factorization_law_triangle_package_alignment⟩ <|
        And.intro ⟨A.native_cross_heart_factorization_law_triangle_named_laws⟩ <|
          And.intro
            ⟨A.theorem_native_cross_heart_factorization_law_triangle_package_alignment.native_cross_heart_factorization_law_triangle_package⟩ <|
            And.intro
              A.theorem_native_cross_heart_factorization_law_triangle_package_alignment.theorem_native_cross_heart_factorization_law_triangle_alignment.theorem_native_cross_heart_factorization_law_alignment.theorem_native_cross_heart_factorization_triangle_alignment.theorem_native_cross_heart_factorization_alignment.theorem_native_cross_heart_image_triangle_alignment.theorem_native_cross_heart_image_alignment.theorem_native_cross_heart_law_alignment.theorem_native_inter_heart_alignment.theorem_native_alignment.theorem_witness.partC_witness <|
              And.intro
