...
/--
Alignment layer connecting the heart-bridge interface back to the named main
theorem parts carried by the load-bearing spine.
-/
theorem YangMillsHeartBridgeConstructiveAlignsWithPartCStatement
  (S : YMLoadBearingSpine)
  (RC : YMConstructiveRoute)
  (h : RC.sharp_local_package.sharp_local_state.extends_bounded_base ->
...
theorem YangMillsHeartBridgeVacuumGapAlignsWithPartDStatement
  (S : YMLoadBearingSpine)
  (RD : YMVacuumGapRoute)
  (h : RD.transport_package.os_transport_ready ->
...
theorem YangMillsHeartBridgeEndpointAlignsWithEndpointPartStatement
  (S : YMLoadBearingSpine)
  (RE : YMEndpointCore)
  (h : RE.endpoint_object.exact_local_net_endpoint ->
...
theorem YangMillsHeartBridgeInterfaceFeedsAlignedTheoremPartsStatement
  (S : YMLoadBearingSpine)
  (RC : YMConstructiveRoute)
  (RD : YMVacuumGapRoute)
  (RE : YMEndpointCore)
  ...
  (RE.endpoint_object.exact_local_net_endpoint ->
    S.theorem_parts.endpoint_exact_object) := by
  have hI := YangMillsHeartBridgeInterfaceData
    RC RD RE
