...
/--
Surface-level summary exposing the higher-level bridge-law assembly.
-/
theorem YangMillsBridgeLawAssemblySummaryStatement :
  ...
  exact
    YangMillsBridgeLawAssemblyWitnessStatement
      RC RD RE
