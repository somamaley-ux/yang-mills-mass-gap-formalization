...
/--
Surface-level summary tying the theorem/native alignment surface to the native
cross-heart compatibility layer.
-/
theorem YangMillsTheoremAssemblyNativeInterHeartAlignmentSummaryStatement :
  ...
  exact
    YangMillsTheoremAssemblyNativeInterHeartAlignmentExportStatement
      S RC RD RE
