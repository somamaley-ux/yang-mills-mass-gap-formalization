...
/--
Surface-level summary exposing named consequences of the unified native-law
assembly.
-/
theorem YangMillsNativeLawConsequencesSummaryStatement :
  ...
  exact
    YangMillsNativeLawConsequencesWitnessStatement
      RC RD RE
