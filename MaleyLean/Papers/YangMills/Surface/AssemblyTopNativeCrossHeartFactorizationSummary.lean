...
theorem/native/native-cross-heart-factorization alignment object.
-/
theorem YangMillsAssemblyTopNativeCrossHeartFactorizationSummaryStatement :
  ...
  exact
    YangMillsTheoremAssemblyNativeCrossHeartFactorizationAlignmentExportStatement
      S RC RD RE
