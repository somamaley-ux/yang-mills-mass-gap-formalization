...
/--
Final theorem-facing Yang-Mills summary layer pointing directly to the
theorem/native/native-cross-heart-factorization-triangle alignment object.
-/
theorem YangMillsAssemblyTopNativeCrossHeartFactorizationTriangleSummaryStatement :
  ...
  exact
    YangMillsTheoremAssemblyNativeCrossHeartFactorizationTriangleAlignmentExportStatement
      S RC RD RE
