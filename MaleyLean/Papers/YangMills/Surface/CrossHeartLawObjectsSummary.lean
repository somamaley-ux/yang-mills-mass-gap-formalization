...
/--
Surface-level summary exposing the typed cross-heart law object.
-/
theorem YangMillsCrossHeartLawObjectsSummaryStatement :
  ...
  exact
    YangMillsCrossHeartLawObjectWitnessStatement
      RC RD RE
