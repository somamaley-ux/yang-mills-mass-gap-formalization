...
/--
Surface-level summary exposing the constructive relational interface once one
finite-cap extension site and one sharp-local assembly site are fixed.
-/
theorem YangMillsConstructiveRelationalSummaryStatement :
  ...
  exact
    YangMillsConstructiveRelationalCompatibilityStatement
