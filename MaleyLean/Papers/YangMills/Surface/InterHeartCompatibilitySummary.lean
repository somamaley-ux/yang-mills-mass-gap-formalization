...
/--
Surface-level summary exposing the named inter-heart compatibility relations
carried by the cross-heart relational assembly.
-/
theorem YangMillsInterHeartCompatibilitySummaryStatement :
  ...
  exact
    YangMillsInterHeartCompatibilityWitnessStatement
      RC RD RE
