...
/--
Surface-level summary exposing the native cross-heart compatibility layer.
-/
theorem YangMillsNativeInterHeartCompatibilitySummaryStatement :
  ...
  exact
    YangMillsNativeInterHeartCompatibilityWitnessStatement
      RC RD RE
