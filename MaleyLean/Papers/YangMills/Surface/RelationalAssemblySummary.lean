...
/--
Surface-level summary exposing the unified cross-heart relational assembly.
-/
theorem YangMillsRelationalAssemblySummaryStatement :
  ...
  exact
    YangMillsRelationalAssemblyWitnessStatement
      RC RD RE
