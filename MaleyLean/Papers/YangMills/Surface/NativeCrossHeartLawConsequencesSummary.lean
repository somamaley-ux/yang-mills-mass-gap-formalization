...
/--
Surface-level summary exposing the native cross-heart law consequences object.
-/
theorem YangMillsNativeCrossHeartLawConsequencesSummaryStatement :
  ...
  exact
    YangMillsNativeCrossHeartLawConsequencesWitnessStatement
      RC RD RE
