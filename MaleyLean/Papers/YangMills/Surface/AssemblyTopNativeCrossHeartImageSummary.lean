...
theorem/native/native-cross-heart-image alignment object.
-/
theorem YangMillsAssemblyTopNativeCrossHeartImageSummaryStatement :
  ...
  exact
    YangMillsTheoremAssemblyNativeCrossHeartImageAlignmentExportStatement
      S RC RD RE
