...
theorem/native/native-inter-heart alignment object.
-/
theorem YangMillsAssemblyTopNativeInterHeartSummaryStatement :
  ...
  exact
    YangMillsTheoremAssemblyNativeInterHeartAlignmentSummaryStatement
      S RC RD RE
