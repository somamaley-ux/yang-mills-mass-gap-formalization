...
/--
Preferred submission-facing Yang-Mills theorem surface.

This summary exports the manuscript-granular theorem object built from:
- the core named-theorem reflection,
- the Lane A per-entry theorem-content bundle,
- the Route 1/QE3 per-entry theorem-content bundle,
- the endpoint per-entry theorem-content bundle.
-/
theorem YangMillsManuscriptGranularTheoremSurfaceSummaryStatement
