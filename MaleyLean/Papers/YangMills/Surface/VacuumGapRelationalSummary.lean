...
/--
Surface-level summary exposing the vacuum-gap relational interface once one
transport site and one reconstruction/gap-evaluation site are fixed.
-/
theorem YangMillsVacuumGapRelationalSummaryStatement :
  ...
  exact
    YangMillsVacuumGapRelationalCompatibilityStatement
