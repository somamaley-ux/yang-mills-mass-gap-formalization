...
/--
Surface-level summary exposing the domain-shaped cross-heart laws carried by
the Yang-Mills relational assembly.
-/
theorem YangMillsCrossHeartLawsSummaryStatement :
  ...
  exact
    YangMillsCrossHeartLawWitnessStatement
      RC RD RE
