...
/--
Surface-level summary exposing the unified three-heart native-law assembly.
-/
theorem YangMillsNativeLawAssemblySummaryStatement :
  ...
  exact
    YangMillsNativeLawAssemblyWitnessStatement
      RC RD RE
