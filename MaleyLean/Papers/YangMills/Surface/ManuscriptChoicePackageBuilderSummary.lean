import MaleyLean.Papers.YangMills.Kernel.ManuscriptChoicePackageBuilder

namespace MaleyLean

theorem YangMillsManuscriptChoicePackageBuilderSummaryStatement
  ...
  exact
    YangMillsManuscriptChoicePackageBuilderStatement
      objects witnesses
      DeltaMax finite_cap_bridge bounded_base_one omega_bd omega_sharp
      transport H Hloc corr gapf hgap
      Omega_loc phi_star E_ren
