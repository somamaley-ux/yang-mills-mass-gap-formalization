...
/--
Surface-level summary exposing the structured constructive-to-vacuum-gap law
package.
-/
theorem YangMillsBoundedBaseTransportLawPackageSummaryStatement :
  ...
  exact
    YangMillsBoundedBaseTransportLawPackageWitnessStatement
      RC RD RE
