...
/--
Surface-level summary exposing the typed native cross-heart law object.
-/
theorem YangMillsNativeCrossHeartLawObjectSummaryStatement :
  ...
  exact
    YangMillsNativeCrossHeartLawObjectWitnessStatement
      RC RD RE
