...
/--
Final theorem-facing Yang-Mills summary layer pointing directly to the stronger
theorem/native/native-cross-heart-image-triangle alignment object.
-/
theorem YangMillsAssemblyTopNativeCrossHeartImageTriangleSummaryStatement :
  ...
  exact
    YangMillsTheoremAssemblyNativeCrossHeartImageTriangleAlignmentExportStatement
      S RC RD RE
