...
theorem YangMillsTheoremAssemblyNativeCrossHeartFactorizationLawTriangleAlignmentExportStatementWrapper
  ...
  S.theorem_parts.partD_vacuum_gap /\
  S.theorem_parts.endpoint_exact_object :=
  YangMillsTheoremAssemblyNativeCrossHeartFactorizationLawTriangleAlignmentExportStatement
    S RC RD RE
