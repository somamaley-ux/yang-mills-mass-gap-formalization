...
/--
Top-level export for the theorem/native/native-cross-heart-factorization-triangle
top summary.
-/
theorem YangMillsAssemblyTopNativeCrossHeartFactorizationTriangleSummaryExportStatement :
  ...
  exact
    YangMillsAssemblyTopNativeCrossHeartFactorizationTriangleSummaryStatement
      S RC RD RE
