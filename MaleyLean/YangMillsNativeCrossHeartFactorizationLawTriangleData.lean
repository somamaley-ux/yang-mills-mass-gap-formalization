...
theorem YangMillsNativeCrossHeartFactorizationLawTriangleDataExportStatement
  ...
  (let T :=
   ...
   T.induced_endpoint_output = T.direct_constructive_endpoint_output) :=
  YangMillsNativeCrossHeartFactorizationLawTriangleDataWitnessStatement
    RC RD RE
    htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
    hww vtm vobs vrsec vcorr vgapf vhgap
    hE hP evac etest efield
