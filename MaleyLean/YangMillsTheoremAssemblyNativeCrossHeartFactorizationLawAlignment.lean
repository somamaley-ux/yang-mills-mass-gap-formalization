...
theorem YangMillsTheoremAssemblyNativeCrossHeartFactorizationLawAlignmentExportStatementWrapper
  ...
  S.theorem_parts.partD_vacuum_gap /\
  S.theorem_parts.endpoint_exact_object :=
  YangMillsTheoremAssemblyNativeCrossHeartFactorizationLawAlignmentExportStatement
    S RC RD RE
