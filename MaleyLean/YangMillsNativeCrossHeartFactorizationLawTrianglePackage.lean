...
theorem YangMillsNativeCrossHeartFactorizationLawTrianglePackageExportStatement
  ...
  YangMillsNativeCrossHeartFactorizationLawTrianglePackageWitnessStatement
    RC RD RE
