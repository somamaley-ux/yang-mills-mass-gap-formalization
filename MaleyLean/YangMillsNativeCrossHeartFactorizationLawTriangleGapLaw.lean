...
theorem YangMillsNativeCrossHeartFactorizationLawTriangleGapLawExportStatement
  ...
  (let L :=
   ...
   L.constructive_gap_output = L.vacuum_gap_output) :=
  YangMillsNativeCrossHeartFactorizationLawTriangleGapLawWitnessStatement
    RC RD RE
    htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
    hww vtm vobs vrsec vcorr vgapf vhgap
    hE hP evac etest efield
