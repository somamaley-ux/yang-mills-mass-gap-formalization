...
theorem YangMillsNativeCrossHeartFactorizationLawTriangleEndpointLawExportStatement
  ...
  (let L :=
   ...
   L.induced_endpoint_output = L.direct_endpoint_output) :=
  YangMillsNativeCrossHeartFactorizationLawTriangleEndpointLawWitnessStatement
    RC RD RE
    htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
    hww vtm vobs vrsec vcorr vgapf vhgap
    hE hP evac etest efield
