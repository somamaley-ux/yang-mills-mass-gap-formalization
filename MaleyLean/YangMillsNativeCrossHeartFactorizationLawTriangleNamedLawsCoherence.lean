...
theorem YangMillsNativeCrossHeartFactorizationLawTriangleNamedLawsCoherenceExportStatement
  ...
  Nonempty (YMNativeCrossHeartFactorizationLawTriangleNamedLawsCoherence RC RD RE) /\
  Nonempty (YMNativeCrossHeartFactorizationLawTriangleNamedLaws RC RD RE) /\
  (let C :=
    YangMillsNativeCrossHeartFactorizationLawTriangleNamedLawsCoherenceData
      RC RD RE
      htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
      hww vtm vobs vrsec vcorr vgapf vhgap
      hE hP evac etest efield
   C.named_laws.gap_law.triangle_package = C.named_laws.endpoint_law.triangle_package) :=
  YangMillsNativeCrossHeartFactorizationLawTriangleNamedLawsCoherenceWitnessStatement
    RC RD RE
    htrunc hext hcompat hunion cwin cbridge cbase cstate cunion
    hww vtm vobs vrsec vcorr vgapf vhgap
    hE hP evac etest efield
