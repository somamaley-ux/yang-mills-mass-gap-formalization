...
theorem YangMillsConstructiveManuscriptChoicesSummaryTopExportStatement
  ...
  exact YangMillsConstructiveManuscriptChoicesSummaryStatement W C

theorem YangMillsConstructiveManuscriptChoicesBuilderSummaryTopExportStatement
  ...
  exact
    YangMillsConstructiveManuscriptChoicesBuilderSummaryStatement
      DeltaMax finite_cap_bridge bounded_base_one omega_bd omega_sharp

theorem YangMillsConstructiveChosenInhabitantsSummaryTopExportStatement
    {RC : YMConstructiveRoute}
    {htrunc : RC.finite_truncation_ready}
    {hext : RC.finite_cap_extension_ready}
    {hcompat : RC.bounded_state_compatibility_ready}
  ...
  exact YangMillsConstructiveChosenInhabitantsSummaryStatement C
