...
theorem YangMillsAssemblyTopNativeCrossHeartFactorizationLawSummaryExportStatement
  ...
  S.theorem_parts.partD_vacuum_gap /\
  S.theorem_parts.endpoint_exact_object :=
  YangMillsAssemblyTopNativeCrossHeartFactorizationLawSummaryStatement
    S RC RD RE
