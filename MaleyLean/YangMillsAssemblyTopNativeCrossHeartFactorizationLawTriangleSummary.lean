...
theorem YangMillsAssemblyTopNativeCrossHeartFactorizationLawTriangleSummaryExportStatement
  ...
  S.theorem_parts.partD_vacuum_gap /\
  S.theorem_parts.endpoint_exact_object :=
  YangMillsAssemblyTopNativeCrossHeartFactorizationLawTriangleSummaryStatement
    S RC RD RE
