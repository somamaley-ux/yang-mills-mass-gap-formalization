...
/--
Top-level export for the theorem/native/native-cross-heart-image top summary.
-/
theorem YangMillsAssemblyTopNativeCrossHeartImageSummaryExportStatement :
  ...
  exact
    YangMillsAssemblyTopNativeCrossHeartImageSummaryStatement
      S RC RD RE
