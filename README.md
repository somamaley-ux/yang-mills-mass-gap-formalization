...
- eports/audits/yang_mills_submission_layer_audit_2026-04-15.md
  referee-facing audit note for the current top package boundary
- eports/support_maps/yang_mills_support_map.txt
  manuscript-to-Lean support map
- eports/status/yang_mills_status.md
...
This project uses Lean 4.28.0 via lean-toolchain.
